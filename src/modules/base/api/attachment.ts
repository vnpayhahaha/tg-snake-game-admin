...
export function pageList(
  params: AttachmentVo
): Promise<ResponseStruct<AttachmentVo[]>> {
...
export function chunkUpload(data: FormData): Promise<ResponseStruct<any>> {
  return useHttp().post("/admin/attachment/chunk/upload", data, {
    headers: {
