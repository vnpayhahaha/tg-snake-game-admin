...
import type { CollectionOrderVo, CollectionOrderVoDataVo } from "~/transaction/api/CollectionOrder";
...
const middleStatisticsHtml = computed(() => {
  ...
  return `
    ...
    | ${formatValue(t("collection_order.query_paid_amount"), tool.formatMoney(responseTableData.value.paid_amount), '#f87171')}
  `;
});
</script>
